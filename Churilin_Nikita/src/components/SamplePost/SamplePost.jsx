...
const SamplePost = () => {
  return (
    <div className="container">
      ...
      <h3 className="center">The Final Frontier</h3>
      <p>
      ...
      pSpaceflights cannot be stopped. This is not the work of any one man or
      even a group of men. It is a historical process which mankind is carrying
      out in accordance with the natural laws of human development.
      <h3 className="center">Reaching for the Stars</h3>
      <p>
