            ...
            <article className="blog-preview">
                <div className="blog-preview__info-block">
                    <h2 className="blog-preview__title">
                        <Link className="link link_main" to={`/blog/${blog._id}`}>{ blog.title }</Link>
                    </h2>
                ...
                <div className="blog-preview__user-block">
                    ...
                    <span className="blog-preview__user-name">
                        <Link className="blog-preview__user-link" to={`/users/${blog.user._id}`} >{blog.user.firstName} {blog.user.lastName}</Link>
                    </span>
                </div>
